        ...
        <div id="mainDiv" class="row col-md-6 " style="margin-left: 100px; margin-top:80px ">
            ...
            <form >
                ...
                <div id="buttonDiv" class="col-md-11 col-md-push-7 form-group">
                    <input type="button" value="Delete" class="btn btn-success buttonSize" onclick="deleteItem()" />
        ...
        <script type="text/javascript">
            ...
            function deleteItem() {
                ...
                if (document.getElementById("itemCodeTf").value) {
                    ...
                    var code = document.getElementById("itemCodeTf").value;

                    //console.log(id+"-"+name+"-"+address)
                    xmlrequest.open("DELETE", "Item?itemCode=" + code, true);
                    //  xmlrequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xmlrequest.send();
