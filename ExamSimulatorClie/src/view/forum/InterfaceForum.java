 ...
 * @author Supun
 */
public class InterfaceForum extends javax.swing.JDialog {
     ...
     */
    public InterfaceForum(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            ...
            try {
                ...
                Logger.getLogger(InterfaceForum.class.getName()).log(Level.SEVERE, null, ex);
...
//        }
            try {
                ...
                final String section = sections.get(4);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceForum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InterfaceForum dialog = new InterfaceForum(new javax.swing.JFrame(), true);
