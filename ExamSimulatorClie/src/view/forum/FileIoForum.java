 ...
 * @author Supun
 */
public class FileIoForum extends javax.swing.JDialog {
     ...
     */
    public FileIoForum(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            ...
            try {
                ...
                Logger.getLogger(FileIoForum.class.getName()).log(Level.SEVERE, null, ex);
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FileIoForum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FileIoForum dialog = new FileIoForum(new javax.swing.JFrame(), true);
