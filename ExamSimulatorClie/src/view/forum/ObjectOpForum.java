 ...
 * @author Supun
 */
public class ObjectOpForum extends javax.swing.JDialog {
     ...
     */
    public ObjectOpForum(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            ...
            try {
                ...
                Logger.getLogger(ObjectOpForum.class.getName()).log(Level.SEVERE, null, ex);
...
//        }
            try {
                ...
                final String section = sections.get(5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ObjectOpForum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ObjectOpForum dialog = new ObjectOpForum(new javax.swing.JFrame(), true);
