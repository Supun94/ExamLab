 ...
 * @author Supun
 */
public class ExceptionForum extends javax.swing.JDialog {
     ...
     */
    public ExceptionForum(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            ...
            try {
                ...
                Logger.getLogger(ExceptionForum.class.getName()).log(Level.SEVERE, null, ex);
...
//        }
            try {
                ...
                final String section = sections.get(1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExceptionForum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ExceptionForum dialog = new ExceptionForum(new javax.swing.JFrame(), true);
