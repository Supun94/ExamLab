 ...
 * @author Supun
 */
public class OthersForum extends javax.swing.JDialog {
     ...
     */
    public OthersForum(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            ...
            try {
                ...
                Logger.getLogger(OthersForum.class.getName()).log(Level.SEVERE, null, ex);
...
//        }
            try {
                ...
                final String section = sections.get(6);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OthersForum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OthersForum dialog = new OthersForum(new javax.swing.JFrame(), true);
