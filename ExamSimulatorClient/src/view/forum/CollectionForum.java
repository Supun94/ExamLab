 ...
 * @author Supun
 */
public class CollectionForum extends javax.swing.JDialog {
     ...
     */
    public CollectionForum(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            ...
            try {
                ...
                Logger.getLogger(CollectionForum.class.getName()).log(Level.SEVERE, null, ex);
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CollectionForum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CollectionForum dialog = new CollectionForum(new javax.swing.JFrame(), true);
