 ...
 * @author Supun
 */
public class ThreadsForum extends javax.swing.JDialog {
     ...
     */
    public ThreadsForum(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            ...
            try {
                ...
                Logger.getLogger(ThreadsForum.class.getName()).log(Level.SEVERE, null, ex);
...
//        }
            try {
                ...
                final String section = sections.get(7);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThreadsForum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThreadsForum dialog = new ThreadsForum(new javax.swing.JFrame(), true);
